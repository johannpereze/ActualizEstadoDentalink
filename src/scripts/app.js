import dentalinkKey from "./key.js"; //Con esto imporantom la key de dentalink sin que qude pública en el repositorio
...
async function actualizarCitasId() {
  ...
  var contenidoCajaArray = document
    .getElementById("textoCitas")
    .value.split("\n");
